...
setwd("~/polar_barplot_seascapes/data/labrador") ## change LME

## read data: the csv file is generated by GET_SEASCAPE_v2.m
seascapes = read_csv(file="hist_vals_labrador.csv", col_names = FALSE) ## change LME
...
filename <- paste("labrador", i, ".jpeg") ## change LME
